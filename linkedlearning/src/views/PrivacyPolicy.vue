<template>
  <div id="page-container">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to Linked learning.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Linked learning, accessible from
          <a
            href="https://linkedlearning.in"
            rel="external nofollow noopener"
            target="_blank"
            >https://linkedlearning.in</a
          >
        </p>
      </li>
      <li>
    ...
    <p>
      The Website may contain interactive features (collectively, “Interactive
      Services”) that allow users to post, submit, publish, display, or transmit
      to other users or other persons (hereinafter, “post”) content or materials
      (collectively, “User Contributions”) on or through the Website. All User
      ...
      assigns the right to use, reproduce, modify, perform, display, distribute,
      and otherwise disclose to third parties any such material for any
      purpose/according to your account settings. You represent and warrant
      that: • You own or control all rights in and to the User Contribution and
      have the right to grant the license granted above to us and our licensees,
      service providers, and other affiliates and each of our and their
      respective successors, and assigns. • All of your User Contributions does
      and will comply with these Terms of Use. • You understand and acknowledge
      that you are responsible for any User Contributions you submit or
      contribute, and you, not the Company, have full responsibility for such
    ...
    <ul>
      <li>By email: ganeshdagadi3@gmail.com</li>
      <li>
        Address : #204, 3rd Main, 3rd Avenure, Teacher's colony, Koramangala,
