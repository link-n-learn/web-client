<template>
  <div id="page-container">
    ...
    <p>Welcome to Linked learning!</p>

    <p>
      These terms and conditions outline the rules and regulations for the use
      of Linked learning's Website, located at https://linkedlearning.in.
    </p>
    ...
    <p>
      We employ the use of cookies. By accessing Linked learning, you agreed to
      use cookies in agreement with the Linked learning's Privacy Policy.
    </p>
    ...
    <p>
      Unless otherwise stated, Linked learning and/or its licensors own the
      intellectual property rights for all material on Linked learning. All
      intellectual property rights are reserved. You may access this from Linked
      learning for your own personal use subjected to restrictions set in these
      terms and conditions.
    </p>

    <p>You must not:</p>
    <ul>
      <li>Republish material from Linked learning</li>
      <li>Sell, rent or sub-license material from Linked learning</li>
      <li>Reproduce, duplicate or copy material from Linked learning</li>
      <li>Redistribute content from Linked learning</li>
    </ul>
    ...
    <p>
      We reserve the right to terminate or suspend the service, in whole or in
      part, without notice or liability, for any reason or no reason, including
      but not limited to violation of our terms and conditions, breach of
      contract, misuse of the service, fraud, or any other conduct that we deem
      inappropriate. We shall not be liable to you or any third party for any
    ...
    <p>
      ...
      hyperlink compensates the absence of Linked learning; and (d) the link is
    ...
    <p>
      ...
      e-mail to Linked learning. Please include your name, your organization
    ...
    <p>
      No use of Linked learning's logo or other artwork will be allowed for
    ...
    <p>
      We have a donation refund policy to ensure fair and transparent processing
      of requests for refund of donations as digital payments are becoming more
      frequent.We expect that all donors will exercise due care and diligence
      while making donations. We also recognises that a donation may be made
      erroneously or donors may change their mind. We will examine each request
      for refund of donation and endeavour to make the refund. We may also seek
      further information / documents and donor must co-operate in this regard.
      However, We are not obliged to make refunds and may, in its discretion,
      decline any requests for refund of donations, If you would like your
      donation to us to be refunded, You must request us in writing or by email
      for a refund and Your request must reach us within 15 (fifteen) days from
      the date on which you made the donation i.e. the date on which you: Made
      the donation online, electronically or through other means, The written
      request stating reason for requesting refund must be sent to the address
      stated below and must contain all the following details pertaining to the
      donation: Date of donation, Donation amount, Transaction Id
    </p>
