        ...
        <div @click="showOneQuestion">
          ...
          <div class="row" id="fifthsq">
            <textarea
              ...
              cols="40"
              style="
                box-shadow: 4px 4px 4px 4px #80808099;
          ...
          <div>
            <button @click="updateAnswer" class="submitsq" style="width: 7vw">
              Submit
            </button>
          </div>
        </div>
    ...
    async showOneQuestion() {
      try {
        ...
        const response = await axios.get(
          `/course/${this.course_id}/question/${this.question_id}`
        );
    ...
    async updateAnswer() {
      try {
        ...
        const response = await axios.post(
          `/course/${this.course_id}/question/${this.question_id}/answer`,
          sendanswer
        );
